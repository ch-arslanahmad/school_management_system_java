...
class testing {
    ...
    public static void main(String[] args) {
         ...
         * String subname = "Matric-I";
         * int subID;
         * if ((subID = sub.getClassIdBySubject(subname)) == -1) {
         * System.out.println("Error -1");
         * } else {
         * System.out.println("ID of " + subname + " is " + subID);
         * }
         * 
         * String newSubName = "9th";
         * if (sub.subjectExists(newSubName)) {
         * sub.deleteSubject(name, newSubName);
         * } else {
         * sub.insertSubject(name, newSubName);
         * }
         * 
         * SubjectDAO.closeLog();
         */
